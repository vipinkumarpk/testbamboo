...
namespace DoctrineORMModule\Proxy\__CG__\Recruiter\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Candidatetype extends \Recruiter\Entity\Candidatetype implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Candidatetype $proxy) {
